            ...
            <table class="table_cart_2_1">
                ...
                <c:forEach var="view" items="${cList }">
	                <tr>
	                    ...
	                    <td>${view.cart_product }</td>
	                    <td>${view.cart_count }개</td>
                    ...
                    <td>
                        ...
                        <div class="paybox">
                            ...
                            <select id="m_card">
                                ...
                                <option>신한은행 110-319-569820 (예금주:(주)권은영)</option>
                                <option>국민은행 0107-187-7995 (예금주:(주)권은영)</option>
                            </select>
                        </div>
                        <div class="paybox">
        ...
        <table class="table_cardpass">            
            ...
            <tr id="card_choice">
                ...
                <td>
                    ...
                    <label for="poca">농협카드</label>&nbsp;
                    <input type="radio" id="geca" name="cardnum">&nbsp;
                    <label for="geca">삼성카드</label>
                </td>
            </tr>
            <tr>
                <td>카드번호</td>

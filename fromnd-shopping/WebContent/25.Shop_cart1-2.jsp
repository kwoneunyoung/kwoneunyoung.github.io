...
%>
    ...
    <div class="div_k2">
            ...
            <table class="table_cart">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img src="images/${vo.p_thumbnail }" alt="thumbnail" style="width:220px; height:202px">
                    </td>
                    <td>${vo.cart_product }</td>
                    <td>
               			<form method="post">
	                        <input type="text" name="quantity" value="${vo.cart_count }" id="l_text">
	                		<input type="hidden" name="p_idx" value="${vo.p_idx }">
        ...
        <div class="div_cart3">
            <input type="button" value="계속 쇼핑하기" id="c_button1" style="float:right; display:inlie-block;" onclick="javascript:location.href='main.jsp'">
          	<form method="post">
            	<input type="hidden" name="userid" value="<%=userid%>">
            	<input type="button" value="장바구니 비우기" id="c_button2" style="float:right; display:inlie-block; margin:1px;" onclick="deleteAll(this.form)">
            </form>
            <form method="post">
	            	<input type="hidden" name="userid" value="<%=userid%>">
	            	<input type="button" value="주문하기" id="c_button3" style="float:right; display:inlie-block; margin:1px;" onclick="goOrderlist(this.form)">
            </form>
        </div>
    </div>
